...
public class WorkloadStateTool {
    ...
    @LlmTool(name = "inspectDeploymentRollout", description = """
    ...
    public String inspectDeploymentRollout(String namespace, String name) {
        ...
        int desired =
                nz(Optional.ofNullable(spec).map(DeploymentSpec::getReplicas).orElse(null));
        int updated = nz(Optional.ofNullable(status)
                .map(DeploymentStatus::getUpdatedReplicas)
                .orElse(null));
        int ready = nz(Optional.ofNullable(status)
                .map(DeploymentStatus::getReadyReplicas)
                .orElse(null));
        int available = nz(Optional.ofNullable(status)
                .map(DeploymentStatus::getAvailableReplicas)
                .orElse(null));
        int unavailable = nz(Optional.ofNullable(status)
                .map(DeploymentStatus::getUnavailableReplicas)
                .orElse(null));
        long observedGen = nzL(Optional.ofNullable(status)
                .map(DeploymentStatus::getObservedGeneration)
                .orElse(null));
        long generation = nzL(d.getMetadata() == null ? null : d.getMetadata().getGeneration());
        boolean paused = Boolean.TRUE.equals(
                Optional.ofNullable(spec).map(DeploymentSpec::getPaused).orElse(false));

        sb.append("  generation:        ").append(generation).append("\n");
        sb.append("  observedGeneration: ").append(observedGen).append("\n");
        sb.append("  paused:            ").append(paused).append("\n");
        sb.append("  replicas:          desired=")
                .append(desired)
                .append("  updated=")
                .append(updated)
                .append("  ready=")
        ...
        DeploymentStrategy strategy =
                Optional.ofNullable(spec).map(DeploymentSpec::getStrategy).orElse(null);
        String strategyType = strategy == null
                ? "RollingUpdate"
                : Optional.ofNullable(strategy.getType()).orElse("RollingUpdate");
        sb.append("  strategy:          ").append(strategyType);
        RollingUpdateDeployment ru = strategy == null ? null : strategy.getRollingUpdate();
        if (ru != null) {
            sb.append("  maxSurge=")
                    .append(intOrStr(ru.getMaxSurge()))
                    .append("  maxUnavailable=")
                    .append(intOrStr(ru.getMaxUnavailable()));
        }
        sb.append("\n");
        Optional.ofNullable(spec)
                .map(DeploymentSpec::getProgressDeadlineSeconds)
                .ifPresent(p -> sb.append("  progressDeadline:  ").append(p).append("s\n"));
        Optional.ofNullable(spec)
                .map(DeploymentSpec::getMinReadySeconds)
                .ifPresent(m -> sb.append("  minReadySeconds:   ").append(m).append("\n"));

        // Conditions
        List<DeploymentCondition> conds =
                Optional.ofNullable(status).map(DeploymentStatus::getConditions).orElse(Collections.emptyList());
        if (!conds.isEmpty()) {
            sb.append("\n  conditions:\n");
    ...
    @LlmTool(name = "getRolloutHistory", description = """
    ...
    @LlmTool(name = "inspectStatefulSetState", description = """
    ...
    public String inspectStatefulSetState(String namespace, String name) {
        ...
        int desired =
                nz(Optional.ofNullable(spec).map(StatefulSetSpec::getReplicas).orElse(null));
        int current = nz(Optional.ofNullable(status)
                .map(StatefulSetStatus::getCurrentReplicas)
                .orElse(null));
        int updated = nz(Optional.ofNullable(status)
                .map(StatefulSetStatus::getUpdatedReplicas)
                .orElse(null));
        int ready = nz(Optional.ofNullable(status)
                .map(StatefulSetStatus::getReadyReplicas)
                .orElse(null));
        int available = nz(Optional.ofNullable(status)
                .map(StatefulSetStatus::getAvailableReplicas)
                .orElse(null));
        long observedGen = nzL(Optional.ofNullable(status)
                .map(StatefulSetStatus::getObservedGeneration)
                .orElse(null));
        long generation = nzL(ss.getMetadata() == null ? null : ss.getMetadata().getGeneration());
        String currentRev = Optional.ofNullable(status)
                .map(StatefulSetStatus::getCurrentRevision)
                .orElse("?");
        String updateRev = Optional.ofNullable(status)
        ...
        sb.append("  serviceName:        ")
                .append(safe(Optional.ofNullable(spec)
                        .map(StatefulSetSpec::getServiceName)
                        .orElse(null)))
                .append("\n");
        sb.append("  podManagementPolicy:")
                .append(" ")
                .append(safe(Optional.ofNullable(spec)
                        .map(StatefulSetSpec::getPodManagementPolicy)
                        .orElse(null)))
                .append("\n");
        sb.append("  replicas:           desired=")
                .append(desired)
        ...
        StatefulSetUpdateStrategy us = Optional.ofNullable(spec)
                .map(StatefulSetSpec::getUpdateStrategy)
                .orElse(null);
        String usType =
                us == null ? "RollingUpdate" : Optional.ofNullable(us.getType()).orElse("RollingUpdate");
        ...
        if (rus != null) {
            ...
            if (rus.getMaxUnavailable() != null)
                sb.append("  maxUnavailable=").append(intOrStr(rus.getMaxUnavailable()));
        }
        sb.append("\n");

        // Conditions
        List<StatefulSetCondition> conds = Optional.ofNullable(status)
                .map(StatefulSetStatus::getConditions)
        ...
        Map<String, String> sel = Optional.ofNullable(spec)
        ...
        if (!sel.isEmpty()) {
            ...
            if (pods.isEmpty()) {
                ...
                sb.append(String.format(
                        "%-55s  %-10s  %-5s  %-9s  %s%n", "POD", "PHASE", "READY", "RESTARTS", "REVISION-LABEL"));
                sb.append("-".repeat(110)).append("\n");
                for (Pod p : pods) {
                    String phase = Optional.ofNullable(p.getStatus())
                            .map(PodStatus::getPhase)
                            .orElse("?");
                    boolean podReady = Optional.ofNullable(p.getStatus())
                    ...
                    String rev = Optional.ofNullable(p.getMetadata().getLabels())
                            .map(l -> l.get("controller-revision-hash"))
                            .orElse("?");
                    sb.append(String.format(
                            "%-55s  %-10s  %-5s  %-9d  %s%n",
        ...
        if (rus != null && nz(rus.getPartition()) > 0) {
            sb.append("  - update strategy has partition=")
                    .append(rus.getPartition())
    ...
    @LlmTool(name = "inspectDaemonSetState", description = """
    ...
    public String inspectDaemonSetState(String namespace, String name) {
        ...
        int desired = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getDesiredNumberScheduled)
                .orElse(null));
        int current = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getCurrentNumberScheduled)
                .orElse(null));
        int updated = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getUpdatedNumberScheduled)
                .orElse(null));
        int ready = nz(
                Optional.ofNullable(status).map(DaemonSetStatus::getNumberReady).orElse(null));
        int available = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getNumberAvailable)
                .orElse(null));
        int unavailable = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getNumberUnavailable)
                .orElse(null));
        int misscheduled = nz(Optional.ofNullable(status)
                .map(DaemonSetStatus::getNumberMisscheduled)
                .orElse(null));
        long observedGen = nzL(Optional.ofNullable(status)
                .map(DaemonSetStatus::getObservedGeneration)
                .orElse(null));
        ...
        Map<String, String> nodeSelector = Optional.ofNullable(spec)
                .map(DaemonSetSpec::getTemplate)
                .map(t -> t.getSpec())
                .map(s -> s.getNodeSelector())
                .orElse(Collections.emptyMap());
        ...
        if (spec != null && spec.getUpdateStrategy() != null) {
            String type =
                    Optional.ofNullable(spec.getUpdateStrategy().getType()).orElse("RollingUpdate");
        ...
        // Conditions
        List<DaemonSetCondition> conds =
                Optional.ofNullable(status).map(DaemonSetStatus::getConditions).orElse(Collections.emptyList());
        if (!conds.isEmpty()) {
            sb.append("\n  conditions:\n");
    ...
    private String deploymentHistory(String namespace, String name) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("=== ROLLOUT HISTORY: Deployment ")
                .append(namespace)
                .append("/")
                .append(name)
                .append(" ===\n\n");
        ...
        for (ReplicaSet rs : rsList) {
            ...
            String change = Optional.ofNullable(rs.getMetadata().getAnnotations())
                    .map(a -> a.get(CHANGE_CAUSE_ANNOTATION))
                    .orElse("<none>");
            int desiredRs = nz(
                    Optional.ofNullable(rs.getSpec()).map(s -> s.getReplicas()).orElse(null));
            int readyRs = nz(Optional.ofNullable(rs.getStatus())
                    .map(s -> s.getReadyReplicas())
                    .orElse(null));
            String created =
                    Optional.ofNullable(rs.getMetadata().getCreationTimestamp()).orElse("?");
            sb.append(String.format(
                    "%-9s  %-50s  %-8d  %-8d  %-22s  %s%n",
                    revision,
                    truncate(rs.getMetadata().getName(), 50),
                    desiredRs,
                    readyRs,
                    truncate(created, 22),
                    truncate(change, 60)));
        ...
        sb.append("\n[NOTE]\n");
        sb.append("  Roll back with: kubectl rollout undo deployment/")
                .append(name)
                .append(" -n ")
                .append(namespace)
                .append(" [--to-revision=N]\n");
        sb.append("  Set change-cause for new rollouts: kubectl annotate deployment/")
                .append(name)
                .append(" kubernetes.io/change-cause='...' -n ")
                .append(namespace)
                .append("\n");
        return sb.toString();
    }
    ...
    private String statefulSetRevisionSummary(String namespace, String name) {
        ...
        StatefulSetStatus status = ss.getStatus();
        StringBuilder sb = new StringBuilder();
        sb.append("=== ROLLOUT HISTORY: StatefulSet ")
                .append(namespace)
                .append("/")
                .append(name)
                .append(" ===\n\n");
        sb.append("  currentRevision: ")
                .append(safe(Optional.ofNullable(status)
                        .map(StatefulSetStatus::getCurrentRevision)
                        .orElse(null)))
                .append("\n");
        ...
        sb.append("  kubectl rollout history statefulset/")
                .append(name)
                .append(" -n ")
                .append(namespace)
                .append("\n");
    ...
    private String daemonSetRevisionSummary(String namespace, String name) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("=== ROLLOUT HISTORY: DaemonSet ")
                .append(namespace)
                .append("/")
                .append(name)
                .append(" ===\n\n");
        sb.append("This tool does not enumerate ControllerRevisions for DaemonSets. Use:\n");
        sb.append("  kubectl rollout history daemonset/")
                .append(name)
                .append(" -n ")
                .append(namespace)
                .append("\n");
    ...
    private List<ReplicaSet> ownedReplicaSets(String namespace, Deployment d) {
        Map<String, String> sel = Optional.ofNullable(d.getSpec())
        ...
        List<ReplicaSet> rsList = kubernetesClient
                .apps()
                .replicaSets()
                .inNamespace(namespace)
                .withLabels(sel)
        ...
        return rsList.stream()
                .filter(rs -> uid == null
                        || Optional.ofNullable(rs.getMetadata().getOwnerReferences())
                                .orElse(Collections.emptyList())
                                .stream()
                                .anyMatch(o -> uid.equals(o.getUid())))
    ...
    private void appendDeploymentSuspicions(
            StringBuilder sb,
            Deployment d,
            List<ReplicaSet> owned,
            int desired,
            int available,
            long generation,
            long observedGen,
        ...
        if (paused) {
            ...
            sb.append("    `kubectl rollout resume deployment/")
        ...
        if (generation > observedGen) {
            sb.append("  - controller has not yet observed generation ")
                    .append(generation)
                    .append(" (observed=")
                    .append(observedGen)
                    .append("). Spec was updated very recently\n");
            sb.append("    or the controller is overloaded.\n");
            any = true;
        }
        Optional<DeploymentCondition> progressing =
                Optional.ofNullable(d.getStatus())
        ...
        progressing.ifPresent(c -> {
            if ("False".equals(c.getStatus())) {
                sb.append("  - Progressing=False (reason=")
                        .append(c.getReason())
                        .append(")\n");
        ...
        Optional<DeploymentCondition> availableCond =
                Optional.ofNullable(d.getStatus())
                        .map(DeploymentStatus::getConditions)
                        .orElse(Collections.emptyList())
                        .stream()
        ...
        if (desired > 0 && available == 0) {
            sb.append("  - 0 of ")
                    .append(desired)
                    .append(" desired replicas are Available — Service traffic to this\n");
            sb.append("    deployment will fail. Run inspectPodResourceHealth on a backing pod.\n");
            any = true;
        }
        long activeRs = owned.stream()
                .filter(rs -> nz(rs.getSpec() == null ? null : rs.getSpec().getReplicas()) > 0)
                .count();
        if (activeRs > 1) {
            sb.append("  - ")
                    .append(activeRs)
                    .append(" ReplicaSets are simultaneously active — rollout is in flight.\n");
            any = true;
        }
